# -*- coding: utf-8 -*-
"""
Created on Wed May 10 11:33:39 2023

This module is for retrieving OSM map data and plotting using cartopy
...
def osm_image(lon,lat,sitename='Columbo',style='map',radius=500,npoints=500):
